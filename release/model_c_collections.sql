...
!echo ------------------------;
!echo ------------------------ claimantCommitment;
!echo ------------------------;
DROP TABLE IF EXISTS src_core_claimantcommitment_claimantcommitment
;

CREATE EXTERNAL TABLE src_core_claimantcommitment_claimantcommitment(
...
CREATE TABLE claimantcommitment STORED AS ORC AS SELECT 
...
COALESCE(`_removed`.`workGroup`, `workGroup`) as workGroup FROM src_core_claimantcommitment_claimantcommitment
